...
public class CrystalRangeSeekbar extends View {
    private static final String TAG = "CrystalRangeSeekbar";
    //////////////////////////////////////////
    // PRIVATE CONSTANTS
    //////////////////////////////////////////
    ...
    public CrystalRangeSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try{
            ...
            Log.e(TAG, "range CrystalRangeSeekbar: maxStartValue "+maxStartValue );
    ...
    public CrystalRangeSeekbar setMaxStartValue(float maxStartValue){
        ...
        Log.e(TAG, "range setMaxStartValue: maxStartValue "+maxStartValue +" absoluteMaxStartValue "+absoluteMaxStartValue );
        return this;
    }
    ...
    public void apply(){
        ...
        Log.e(TAG, "range apply: maxStartValue "+maxStartValue +" absoluteMinStartValue "+absoluteMinStartValue );
        Log.e(TAG, "range apply: con 1 "+(maxStartValue < absoluteMinStartValue) );
        Log.e(TAG, "range apply: con 2 "+(maxStartValue < absoluteMinValue) );
        // set max start value
        if (maxStartValue < absoluteMinStartValue || maxStartValue <= absoluteMinValue) {
            maxStartValue = 0;
            Log.e(TAG, "range apply: maxStartValue if "+maxStartValue );
            setNormalizedMaxValue(maxStartValue);
        }
        else if(maxStartValue >= absoluteMaxValue){
            maxStartValue = absoluteMaxValue;
            Log.e(TAG, "range apply: maxStartValue else if "+maxStartValue );
            setMaxStartValue();
        }
        else{
            Log.e(TAG, "range apply: else "+maxStartValue );
            setMaxStartValue();
        }
        invalidate();
    ...
    protected float getMaxStartValue(final TypedArray typedArray){
        Log.e(TAG, "range getMaxStartValue: maxValue "+maxValue );
