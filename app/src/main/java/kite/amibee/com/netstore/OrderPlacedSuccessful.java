...
public class OrderPlacedSuccessful extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_placed_successful);
        ...
        new Handler().postDelayed(new Runnable(){
            ...
            public void run() {
                ...
                if (preferencesHelper.getUserRegister()){
                    Intent mainIntent = new Intent(OrderPlacedSuccessful.this,HomeActivity.class);
                    startActivity(mainIntent);
                    finish();
                }/*else {
                    Intent mainIntent = new Intent(OrderPlacedSuccessful.this,SignInActivity.class);
                    startActivity(mainIntent);
